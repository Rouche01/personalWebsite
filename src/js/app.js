...
window.addEventListener("load", () => {
  ...
  router.add("/", () => {
    ...
    $("meta[property='og\\:url']").attr(
      "content",
      `https://richardemate.com/index.html`
    );
    $("meta[property='og\\:image']").attr("content", "placeholder.jpg");
    $("meta[property='og\\:description']").attr(
      "content",
      "Welcome to the official website of Richard Emate"
    );
  ...
  router.add("/about", () => {
    ...
    $("meta[property='og\\:url']").attr(
      "content",
      `https://richardemate.com/about`
    );
    $("meta[property='og\\:image']").attr("content", "placeholder.jpg");
    $("meta[property='og\\:description']").attr(
      "content",
      "My story, my values, my work & my life"
    );
  ...
  router.add("/blog", async () => {
    ...
    try {
      ...
      $("meta[property='og\\:title']").attr(
        "content",
        "Latest thoughts from me"
      );
      $("meta[property='og\\:url']").attr(
        "content",
        `https://richardemate.com/blog`
      );
      $("meta[property='og\\:image']").attr("content", "placeholder.jpg");
      $("meta[property='og\\:description']").attr(
        "content",
        "These are the list of my latest thoughts and updates from me"
      );
  ...
  router.add("/now", () => {
    ...
    $("meta[property='og\\:url']").attr(
      "content",
      `https://richardemate.com/now`
    );
    $("meta[property='og\\:image']").attr("content", "placeholder.jpg");
    $("meta[property='og\\:description']").attr(
      "content",
      "Projects, Adventures, Experiments, Learnings and Hobbies"
    );
  ...
  router.add("{blogSlug}", async (blogSlug) => {
    ...
    try {
      ...
      const resourceIndex = allResources.findIndex(
        (resource) => resource.slug === blogSlug
      );
      ...
      if (blogpostIndex !== -1) {
        ...
        $("meta[property='og\\:url']").attr(
          "content",
          `https://richardemate.com/${blogSlug}`
        );
        $("meta[property='og\\:image']").attr(
          "content",
          clickedEl.featuredImage.url
        );
        $("meta[property='og\\:description']").attr(
          "content",
          clickedEl.excerpt
